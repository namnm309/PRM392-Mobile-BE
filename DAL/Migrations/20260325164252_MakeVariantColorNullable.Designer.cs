...
namespace DAL.Migrations
{
    ...
    [Migration("20260325164252_MakeVariantColorNullable")]
    partial class MakeVariantColorNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.ProductComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("tbl_product_comments");
                });
            ...
            modelBuilder.Entity("DAL.Models.ProductVariant", b =>
                {
                    ...
                    b.HasIndex("ProductId", "ColorName", "RamGb", "StorageGb")
                        .IsUnique();

                    b.ToTable("tbl_product_variants");
                });
            ...
            modelBuilder.Entity("DAL.Models.ProductComment", b =>
                {
                    b.HasOne("DAL.Models.ProductComment", "Parent")
                        .WithMany("Replies")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("DAL.Models.ReviewReply", b =>
                {
                    b.HasOne("DAL.Models.Review", "Review")
                        .WithOne("Reply")
                        .HasForeignKey("DAL.Models.ReviewReply", "ReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
